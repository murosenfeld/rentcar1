$(document).ready(function () {
    ...
    if (email === 'martin@gmail.com') {
        $('#ver').show() && $('#ver2').show() && $('#edit').show() && $('#registrado').hide() && $('#service').hide() && $('.btn-sign').hide()&& $('#client').show();
    }
});
...
var r = Math.floor(Math.random()*256);
            ...
            if (hexR.length == 1) {
            	...
            	console.log(hexColor);
	                ...
	                $.getJSON('server/statistical1.php', function(data) {
                    var items = '';
                    ...
                    $("#chartData").html("<tr><th>Mark</th><th>Quantity</th></tr>" + items);
                ...
                function pieChart() {
                    ...
                    function startPullOut(slice) {
                        ...
                        $('#chartData td').removeClass('highlight');
                        var labelCell = $('#chartClient td:eq(' + (slice * 2) + ')');
                        var valueCell = $('#chartClient td:eq(' + (slice * 2 + 1) + ')');
                    ...
                    function pushIn() {
                        ...
                        drawChart();
                        $('#chartData td').removeClass('highlight');
                        $('#chartClient td').removeClass('highlight');
                    }
